...
// Import Products Screen untuk navigasi search/brand
    ...
    return _carouselImages.map((imagePath) {
      return Container(
        ...
        child: ClipRRect(
          ...
          child: Image.asset(imagePath, fit: BoxFit.cover, errorBuilder: (c, e, s) => Container(color: Colors.grey, child: const Icon(Icons.error))),
        ),
      );
    }).toList();
  }
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Image.asset('assets/images/logo.png', width: 32, height: 32, errorBuilder: (c, e, s) => const Icon(Icons.phone_android, color: orange)),
                  ...
                  GestureDetector(
                    ...
                    child: const CircleAvatar(
                      ...
                      child: Icon(Icons.person_outline, color: orange, size: 20),
                    ),
                  ),
                  const SizedBox(width: 10),
                  GestureDetector(
                  ...
                  children: [
                    ...
                    if (!authProvider.isLoggedIn)
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              const Text('Masuk atau daftar untuk menikmati berbelanja dengan maksimal',
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Text('Pilihan Brand', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                          GestureDetector(
                            onTap: () => Navigator.pushNamed(context, '/products'),
                            child: Container(
                              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                              decoration: BoxDecoration(color: const Color(0xFF545454), borderRadius: BorderRadius.circular(20)),
                              child: const Text('Lihat Lain', style: TextStyle(fontSize: 12, color: Colors.white)),
                            ),
                          ),
                        ],
                      ),
                        ...
                        children: _brands.map((brand) {
                          return Padding(
                            ...
                            child: GestureDetector(
                              // LOGIKA KLIK BRAND
                              onTap: () {
                                print("Brand Clicked: ${brand['name']}"); // Debug Log
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                              ...
                              child: Container(
                                ...
                                child: Image.asset(brand['logo']!, fit: BoxFit.contain, errorBuilder: (c, e, s) => Center(child: Text(brand['name']![0]))),
                              ),
                            ),
                          );
                        }).toList(),
                    ...
                    const Padding(
                      ...
                      child: Text('Pilihan terbaik minggu ini', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                    ),
                    const SizedBox(height: 14),
                                ...
                                children: [
                                  Expanded(
                                    child: Container(
                                      ...
                                      padding: const EdgeInsets.all(12),
                                      child: Image.asset(product['image'], fit: BoxFit.contain, errorBuilder: (c, e, s) => const Icon(Icons.broken_image)),
                                    ),
                                  ),
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(formatCurrency(product['price']), style: const TextStyle(color: Colors.white, fontSize: 12)),
                                        const SizedBox(height: 8),
                                        SizedBox(
                                          width: double.infinity,
                                          height: 30,
                                          child: ElevatedButton(
                                            style: ElevatedButton.styleFrom(backgroundColor: orange, padding: EdgeInsets.zero),
